  ...
  switch (expression.type) {
    ...
    case "IfExpression":
      return validateIfExpression(
        ...
        new LexicalContext({ parentContext: lexicalContext})
      );
    case "WhileExpression":
      return validateWhileExpression(
...
function validateWhileExpression(
  ...
  if (conditionSymbolInfo.type !== "boolean") {
    throw new Error("While expressions must have boolean conditions");
  }
